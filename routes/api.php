...
Route::get('inventario/reportes/general/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioGeneral');

Route::get('inventario/reportes/estadal/{estado_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioEstadal');


Route::get('inventario/reportes/municipal/{municipio_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioMunicipal');


Route::get('inventario/reportes/centro_salud/{centro_salud_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioCentroSalud');


// REPORTES INVENTARIOS POR ESTADOS Y ESTATUS //

Route::get('inventario/reportes/general/estatus/{equipo}/{estatu_equipo_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioGeneralPorEstatus');


Route::get('inventario/reportes/estadal/estatus/{equipo}/{estado_id}/{estatu_equipo_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioEstadalPorEstatus');

Route::get('inventario/reportes/municipal/estatus/{equipo}/{municipio_id}/{estatu_equipo_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioMunicipalPorEstatus');

Route::get('inventario/reportes/centro_salud/estatus/{equipo}/{centro_salud_id}/{estatu_equipo_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioCentroSaludPorEstatus');
...
Route::get('inventario/reportes/estadal/reparado/{equipo}/{estado_id}/{reparado}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioEstadalPorReparados');

Route::get('inventario/reportes/municipal/reparado/{equipo}/{municipio_id}/{reparado}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioMunicipalPorReparados');

Route::get('inventario/reportes/centro_salud/reparado/{equipo}/{centro_salud_id}/{reparado}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioCentroSaludPorReparados');
...
Route::get('inventario/reportes/buscar_equipo/{equipo}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioBuscarEquipo');
Route::get('inventario/reportes/buscar_equipo/estados/{equipo}/{estado_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioBuscarEquipoEstados');
Route::get('inventario/reportes/buscar_equipo/municipios/{equipo}/{municipio_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioBuscarEquipoMunicipios');
Route::get('inventario/reportes/buscar_equipo/centro_salud/{equipo}/{centro_salud_id}/{fecha1}/{fecha2}', 'InventarioController@ReporteInventarioBuscarEquipoCentroSalud');
